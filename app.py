...
def chatbot_response(message):
    ...
    if any(word in message for word in ["hi", "hello", "hey", "hii"]):
        return "Hello! 👋 I'm your Heart Disease Assistant. How can I help you?"

    elif "project" in message or "about" in message:
        return (
            "This is a Heart Disease Prediction System that uses "
            "Machine Learning to predict the possibility of heart disease."
        )

    elif "heart disease" in message:
        return (
        ...
        return (
            "Common symptoms may include chest discomfort, shortness of breath, "
            "fatigue, dizziness and irregular heartbeat."
        )

    elif "risk" in message:
        return (
            "Common risk factors include age, high blood pressure, high cholesterol, "
            "diabetes, smoking, obesity and physical inactivity."
        )

    elif "machine learning" in message or "ml" in message:
        return (
            "Machine Learning helps the system learn patterns from existing "
            "heart-disease data and make predictions on new data."
        )

    elif "model" in message or "algorithm" in message:
        return (
            "The project uses Logistic Regression, Decision Tree, Random Forest, "
            "SVM, KNN and Gradient Boosting."
        )

    elif "random forest" in message:
        return (
        ...
        return (
            "ECG stands for Electrocardiogram. It records the electrical "
            "activity of the heart."
        )

    elif "prediction" in message or "predict" in message:
        return (
            "Enter the required patient information in the prediction form. "
            "The trained Machine Learning model will generate the prediction."
        )
        ...
        return (
            "You can ask me about heart disease, ECG, Machine Learning, "
            "models, inputs, predictions or performance."
        )
        ...
        return (
            ...
            "heart disease, ECG, Machine Learning, models or predictions."
        )
